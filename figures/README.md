...
| 9 | [`chart9_f1_comparison_across_algorithms.png`](chart9_f1_comparison_across_algorithms.png) | F1 comparison across classifiers | [`description`](descriptions/chart9_f1_comparison_across_algorithms.md) | Best committed F1: IBM MLP 0.5783, Job Change RF 0.6042, Promotion MLP 0.5054. |
...
| 16 | [`ibm_attrition_confusion_matrices.png`](ibm_attrition_confusion_matrices.png) | IBM confusion matrices for four classifiers | [`description`](descriptions/ibm_attrition_confusion_matrices.md) | Demonstrates accuracy/recall trade-offs; RF accuracy 0.8469 coexists with recall 0.1064. |
