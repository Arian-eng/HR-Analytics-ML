# Local reproducible run — 2026-08-17

The supplied CSV files were executed locally with `test_size=0.20` and `random_state=42`. The classifier benchmark below uses a fixed, computationally reproducible model configuration (not GridSearch):
...
- Neural Network: one hidden layer of 30 units, `alpha=0.001`, early stopping, max 50 iterations
...
- RF: `[[2573, 304], [575, 380]]`
- DT: `[[2099, 778], [243, 712]]`
- SVM: `[[2148, 729], [256, 699]]`
- NN: `[[2579, 298], [525, 430]]`

### Employee Performance
- RF: `[[1846, 388], [690, 560]]`
- DT: `[[1590, 644], [501, 749]]`
- SVM: `[[1412, 822], [388, 862]]`
- NN: `[[1902, 332], [731, 519]]`
...
These numbers supersede older draft numbers only when the thesis uses this fixed benchmark configuration. They should not be mixed with earlier GridSearch results. In particular, the older IBM RF=0.86 claim should not be combined with this fixed benchmark. The positive-class metrics also show why accuracy alone is insufficient for imbalanced IBM Attrition data.
